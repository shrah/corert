...
namespace System.Runtime.InteropServices
{
    public partial class ExternalInterop
    {
        ...
        {
            throw new PlatformNotSupportedException("SysAllocString");
        }

        internal static unsafe char* SysAllocStringLen(char* pStrIn, uint len)
        {
            throw new PlatformNotSupportedException("SysAllocStringLen");
        }

        public static unsafe void SysFreeString(IntPtr pBstr)
        {
             throw new PlatformNotSupportedException("SysFreeString");
        }
    }
}
