...
#pragma warning restore 649
        ...
        {
#if ENABLE_WINRT
            __com_IStream* pIStream = (__com_IStream*)PInvokeMarshal.CoTaskMemAlloc(new UIntPtr(sizeof(__com_IStream)));
            pIStream->pVtable = (__vtable_IStream*)__vtable_IStream.GetVtable();
            pIStream->m_cbCurrent = 0;
            pIStream->m_cRef = 1;
            pIStream->m_cbSize = (int)lSize;
            pIStream->m_pMem = (byte*)PInvokeMarshal.CoTaskMemAlloc(new UIntPtr((int)lSize));
